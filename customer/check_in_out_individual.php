...
@media (max-width:890px) {
    ...
    <body class="has1">
        ...
        <div class="form-group">
            ...
            <button type="submit" class="btn btn-success" name="check_in_individual">Check In</button>

            <button type="submit" class="btn btn-warning" name="check_out_individual">Check Out</button>
