const getGraphIncome = async (btnType) => {
    let date;
    let response;
    let json;
    ...
    if (btnType == "day") {
        ...
        try {
            response = await fetch('model/report/income/apiGetReportIncomeD.php', {
                method: "POST",
                body: JSON.stringify({
                    date: date,
                    week: label
        ...
        try {
            response = await fetch('model/report/income/apiGetReportIncomeM.php', {
                method: "POST",
                body: JSON.stringify({
                    date: date
                }),
        ...
        try {
            response = await fetch('model/report/income/apiGetReportIncomeW.php', {
                method: "POST",
                body: JSON.stringify({
                    date: date
                }),
        ...
        try {
            response = await fetch('model/report/income/apiGetReportIncomeY.php', {
                headers: {
                    "Content-type": "application/json; charset=UTF-8"
                }
            });
    ...
    getDetailGraph(label, value, 'income');
    showContainerGraph();
}