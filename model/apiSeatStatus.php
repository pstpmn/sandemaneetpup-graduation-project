...
where DATE(`travel_date`) = DATE('" . $date . "') AND boat_number = " . $input['boatNumber'] . " AND (ticket_status_id = 1 OR ticket_status_id = 2 OR ticket_status_id = 4) AND boat_seat.floor = '".$input['floor']."' ");
if ($qeueryData == true) {
